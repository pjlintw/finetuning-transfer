...
def main(args: FlatArguments):
    ...
    # # Filter function for the dat   aset
    # def filter_dataset(example, max_length=1024):
    #     # Calculate total length for the given example
    #     total_length = sum(1 + len(msg["content"].split(" ")) for msg in example["messages"])
    #     # Return True if the length is within the max allowed length
